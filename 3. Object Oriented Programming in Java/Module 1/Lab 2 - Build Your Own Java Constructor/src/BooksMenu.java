    ...
    public static void main(String s[]) {
        ...
        while(true) {
            System.out.println(
                ...
                "Press '4' to compare if two books are equal.\n" +
                "Press '0' to exit."
            );
            ...
            if (userAction.equals("1")) {
                ...
                if(books[bookOneIndex] != null && books[bookTwoIndex] != null) {
                    boolean areBooksEqual = books[bookOneIndex].areBooksEqual(books[bookTwoIndex]);
                ...
                int bookIndexUserInput = Integer.parseInt(scanner.nextLine());

                if(books[bookIndexUserInput] != null) {
                    Book newBook = new Book();
                    newBook.setTitle(books[bookIndexUserInput].getTitle());
                    newBook.setAuthor(books[bookIndexUserInput].getAuthor());
                    newBook.setPrice(books[bookIndexUserInput].getPrice());
